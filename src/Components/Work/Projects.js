...
const Projects = () => {
  ...
  return (
    <Box
      id="projects"
      className="workDiv"
      sx={{ width: "80%", margin: "15% auto", padding: "0% 10px" }}
    >
            ...
            <ListItem key={index} style={{ display: "block" }}>
              <Zoom in={checked1}>
                ...
                >
                  ...
                  <img className="projectImage" width="100%" src={ele.img} />
